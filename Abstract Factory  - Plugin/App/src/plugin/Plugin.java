...
public class Plugin {
    ...
    public String createCar(ICarFactory factory){
        String motorString = null;
        String chassiString = null;
        String pneuString = null;
        
        IMotor motor = factory.createMotor();
        motorString = motor.turn();
        IChassi chassi = factory.createChassi();
        chassiString = chassi.drawNumber();
        IPneu pneu = factory.createPneu();
        pneuString = pneu.calibrate();
        System.out.println("\n");
        return motorString + "\n" + chassiString + "\n" + pneuString;
    }
